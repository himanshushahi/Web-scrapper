...
function ProductCard({ product }) {
  return (
    <div
      key={product._id}
      className="basis-1/3 max-md:basis-full rounded bg-gray-100 overflow-hidden shadow-lg"
    >
      <Image
      ...
      <div className="px-6 py-4">
        ...
        <div className="flex justify-between">
          <p className="text-green-600 text-base">₹{product.currentPrice}</p>{" "}
          <p className="text-blue-500">{product.provider}</p>
        </div>
      </div>
      <div className="px-6 py-4">
